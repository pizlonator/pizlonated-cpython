...
#if !defined(Py_GIL_DISABLED) && !defined(Py_USING_MEMORY_DEBUGGER) && !defined(__PIZLONATOR_WAS_HERE__)
...
#endif /* !defined(Py_GIL_DISABLED) && !defined(Py_USING_MEMORY_DEBUGGER) && !defined(__PIZLONATOR_WAS_HERE__) */
